...
- Timestamp: `2022-06-12 22:18`
- Build ID: `bfe1d0b7-4bea-4d2b-8c92-6692bb3b2979`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/bfe1d0b7-4bea-4d2b-8c92-6692bb3b2979.git
$ cd bfe1d0b7-4bea-4d2b-8c92-6692bb3b2979
```
